...
private function list(array $columns=null,array $search = null):? Pagination{  
...
private function _list(array $columns =null ,array $search=null):? Pagination{
    ...
    $lenght = 10;
    $paging = new Pagination($this->sql,$query,$limit,$lenght,"pg=".$pg."&option=".$option, isset($input) ?$input:  []);
    return $paging ;
}
