...
global $pg,$option,$target,$view,$viewpage,$msg,$status,$keys,$microtime,$formToken,$currentuser,$currentusercode;

### System Variables
define("DEV_MODE",'false');
define("APP_NAME","Collection Hub");
define("APP_FAVICON","media/img/favicon.png");
define("APP_LOGO","media/img/logo.svg");
...
define("SPATH_WEB",    SPATH_ROOT.DS."web");
...
define( "EXTERNAL_URL"	   ,	"localhost/collectionhub/collection.web/" );
...
include SPATH_LIBRARIES.DS."lib.OrconsMailer.php";
...
include SPATH_LIBRARIES.DS."lib.setup.web.php";
