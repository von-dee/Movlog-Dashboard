...
//                echo "Query returned zero rows.";
    ...
    function limitList($limit,$formname){
        ...
        echo '<select name="limit" onchange="document.'.$formname.'.submit();document.getElementById(\'view \').value=\'makepayment\'" style="width:60px;padding-left:5px; height:31px;border-radius:5px; border:1px solid #EFEFEF;">
