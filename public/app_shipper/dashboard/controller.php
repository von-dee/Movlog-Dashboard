  ...
  class lists extends \setup { 
    public $limit,$usedstatus,$employeeno;
      ...
      function Init(){
        ...
        $result = ['request_inprogress'=>$inprogress_response, 'request_hdv_inprogress'=>$inprogress_hdv_response, 'request_completed'=>$completed_response, 'request_cancelled'=>$cancelled_response ];
