...
<div class="page-content-wrapper-inner">
    <div class="content-viewport">
        <div class="row">
            <div class="col-12 ">
                <h4>Your Messages</h4>
                <p class="text-gray">Get a list of all your messages. </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            ?>
                ...
                <div class="col-lg-10">
                    <div class="grid">
                        <div class="grid-body">
                            <span class="grid-title order_num"><?php echo $value['MESG_DATEADDED']; ?></span>
                            <div class="row">
                                <div class="col-lg-1">
                                    <div class="image-wrapper">
                                        <img class="profile-img" src="<?php echo $value['MESG_IMG_URL']; ?>" alt="profile image">
                                        <div class="status-indicator rounded-indicator bg-success"></div>
                                    </div>
                                </div>
                                <div class="col-lg-11">
                                    <div class="content-wrapper">
                                        <small class="name"><?php echo $value['MESG_SENDER_NAME']; ?></small> 
                                        <small class="content-text"><?php echo $value['MESG_BODY']; ?></small>
                                    </div>
                                </div>
                            </div>
                        </div>
