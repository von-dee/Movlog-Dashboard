...
<div class="page-content-wrapper-inner">
    <div class="content-viewport">
        <div class="row">
            <div class="col-12 ">
                <h4>Your Requests</h4>
                <p class="text-gray">Get info on your requests status. </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <span class="light_heading">New Requests  [: Freight Vehicles] </span>

                <?php
                    foreach($result['newrequest_response'] as $keyd => $value){ 
            ...
            <div class="col-lg-12">
                <span class="light_heading">New Requests [: Heavy Duty Vehicles] </span>

                <?php
                    foreach($result['newrequest_hvd_response'] as $keyd => $value){ 
            ...
            <div class="col-lg-12">
                <span class="light_heading">Completed [: Freight Vehicles]</span>

                <?php
                    foreach($result['completed_response'] as $keyd => $value){ 
                        $data = $engine->getDataEncrypt($value);
                ?>
            ...
            <div class="col-lg-12">
                <span class="light_heading">Completed [: Heavy Duty Vehicles]</span>

                <?php
                    foreach($result['completed_hdv_response'] as $keyd => $value){ 
                        $items = json_decode($value['REQ_VEHICLES']);
                        $data = $engine->getDataEncrypt($value);
                ?>
