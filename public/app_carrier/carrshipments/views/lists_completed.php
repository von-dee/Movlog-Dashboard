...
<div class="page-content-wrapper-inner">
    <div class="content-viewport">
        <div class="row">
            <div class="col-12 ">
                <h4>Your Completed Requests</h4>
                <p class="text-gray">Get info on your completed requests status. </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <span class="light_heading">Completed [: Freight Requests]</span>
            ...
            <div class="col-lg-12">
                <span class="light_heading">Heavy Duty Requests Completed</span>

                <?php
                    foreach($result['request_hdv_completed'] as $keyd => $value){ 
