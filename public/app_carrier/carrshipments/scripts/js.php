<script>
    ...
    //////////////////////////// PROGRESSIVE FORM START //////////////////////////////////////
        ...
        function intransit(data){
            ...
            swalWithBootstrapButtons.fire({
                title: 'In Transit?',
                text: "Has the Driver begun the trip?",
                icon: 'info',
                showCancelButton: true,
                confirmButtonText: 'Yes, He has!',
                cancelButtonText: 'Cancel',
                reverseButtons: true
            }).then((result) => {
                if (result.value) {
                    swalWithBootstrapButtons.fire(
                    'Successful!',
                    'You changed the status to In-Transit.',
                    'success'
                    )

                    $('#pg').val('appshipments');
                    $('#view').val('details');
                    $('#class_call').val('status_update');
                    $('#keys').val(data);
        ...
        function atdestination(data){
            ...
            swalWithBootstrapButtons.fire({
                ...
                text: "Has the Driver arrived at the destination?",
                icon: 'info',
                showCancelButton: true,
                confirmButtonText: 'Yes, He is!',
                cancelButtonText: 'Cancel',
                reverseButtons: true
            }).then((result) => {
                if (result.value) {
                    swalWithBootstrapButtons.fire(
                    'Successful!',
                    'You acknowledging that driver has arrived.',
                    'success'
                    )
                    ...
                    swalWithBootstrapButtons.fire(
                    'Cancelled',
                    'You cancelled driver being at destination',
                    'error'
                    )
                }
            })
        ...
        function completed(data){
            ...
            swalWithBootstrapButtons.fire({
                title: 'Completed?',
                text: "Confirm client has the package?",
                icon: 'info',
                showCancelButton: true,
                confirmButtonText: 'Yes, package delivered!',
                cancelButtonText: 'Cancel',
                reverseButtons: true
            }).then((result) => {
                if (result.value) {
                    ...
                    swalWithBootstrapButtons.fire(
                    'Cancelled',
                    'You didnt set the trip to completed',
                    'error'
                    )
                }
            })
