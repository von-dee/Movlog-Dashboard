<?php 
  ...
  class lists_hvd_completed extends \setup { 
    public $limit,$usedstatus,$employeeno;
      ...
      function Init(){
        ...
        $driver_filter = ['URQ_TYPE'=>"2",'URQ_DRIVER_COMP_CODE'=>$usercompanycode,'URQ_STATUS'=>['$in'=> ["5"]]];
        $driver_options =  [];
        ...
        $result = ['completed_hdv_response'=>$completed_hdv_response];
