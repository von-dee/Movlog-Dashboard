  ...
  class lists extends \setup { 
    public $limit,$usedstatus,$employeeno;
      ...
      function Init(){
        ...
        /////////// NEW REQUESTS HEAVY DUTY VEHICLES/////////////
        $newrequest_hvd_response = [];
        $newrequests_collection = "app_request_construction";
        $newrequests_filter = ['REQ_STATUS'=>"1"];
        $newrequests_options = ['sort'=>['REQ_DATEADDED'=>-1],'limit'=>10,'skip'=>$skipval];
        $newhdvrequests = $this->mongo->GetAll($newrequests_collection,$newrequests_filter,$newrequests_options);

        if(!empty($newhdvrequests)){

          foreach ($newhdvrequests as $val){
            ...
            array_push($newrequest_hvd_response, $val);
          }
        ...
        $inprogress_response = [];
        $driver_collection = "app_accepted_request";
        $driver_filter = ['URQ_DRIVER_COMP_CODE'=>$usercompanycode,'URQ_TYPE'=>"1",'URQ_STATUS'=>['$in'=> ["2","3","4"]]];
        $driver_options =  [];
        ...
        if(!empty($driver_stmt)){
            ...
            foreach ($driver_stmt as $val){
              $requests_collection = "app_request";
              ...
              $val['REQ_ITEMS'] = $requests_stmt['REQ_ITEMS'];
              ...
              $val['REQ_LOCATION_FROM'] = $requests_stmt['REQ_LOCATION_FROM'];
              $val['REQ_LOCATION_ID_FROM'] = $requests_stmt['REQ_LOCATION_ID_FROM'];
              $val['REQ_DESCRIPTION'] = $requests_stmt['REQ_DESCRIPTION'];
              $val['REQ_PICKUP_DATE'] = $requests_stmt['REQ_PICKUP_DATE'];
              $val['REQ_PICKUP_TIME'] = $requests_stmt['REQ_PICKUP_TIME'];
              $val['REQ_TOTAL_ITEMS'] = $requests_stmt['REQ_TOTAL_ITEMS'];
              $val['REQ_TOTAL_AMOUNT'] = $requests_stmt['REQ_TOTAL_AMOUNT'];
              $val['REQ_DATEADDED'] = $requests_stmt['REQ_DATEADDED'];
              $val['REQ_TRUCK_TYPE'] = $requests_stmt['REQ_TRUCK_TYPE'];
              $val['REQ_TRUCK_NAME'] = $requests_stmt['REQ_TRUCK_NAME'];
              $val['REQ_TRUCK_URL'] = $requests_stmt['REQ_TRUCK_URL'];
        ...
        $driver_collection = "app_accepted_request";
        $driver_filter = ['URQ_DRIVER_COMP_CODE'=>$usercompanycode,'URQ_TYPE'=>"2",'URQ_STATUS'=>['$in'=> ["2","3","4"]]];
        $driver_options =  [];
        $driver_stmt = $this->mongo->GetAll($driver_collection,$driver_filter,$driver_options);
        ...
        $completed_response = [];
        $driver_collection = "app_accepted_request";
        $driver_filter = ['URQ_DRIVER_COMP_CODE'=>$usercompanycode,'URQ_TYPE'=>"1",'URQ_STATUS'=>['$in'=> ["5"]]];
        $driver_options =  [];
        $driver_stmt = $this->mongo->GetAll($driver_collection,$driver_filter,$driver_options);
        ...
        /////////// COMPLETED REQUESTS HEAVY DUTY /////////////
        $completed_hdv_response = [];
        $driver_collection = "app_accepted_request";
        $driver_filter = ['URQ_DRIVER_COMP_CODE'=>$usercompanycode,'URQ_TYPE'=>"2",'URQ_STATUS'=>['$in'=> ["5"]]];
        $driver_options =  [];
        $driver_stmt = $this->mongo->GetAll($driver_collection,$driver_filter,$driver_options);
        ...
        $result = [
          'newrequest_response'=>$newrequest_response ,'newrequest_hvd_response'=>$newrequest_hvd_response,
          'request_inprogress'=>$inprogress_response, 'request_hdv_inprogress'=>$inprogress_hdv_response,  
          'completed_response'=>$completed_response,'completed_hdv_response'=>$completed_hdv_response
        ];
