<?php 
  ...
  class lists_hvd_cancelled extends \setup { 
    public $limit,$usedstatus,$employeeno;
      ...
      function Init(){
        ...
        $driver_filter = ['URQ_TYPE'=>"2",'URQ_DRIVER_COMP_CODE'=>$usercompanycode,'URQ_STATUS'=>['$in'=> ["0"]]];
        $driver_options =  [];
        ...
        $result = ['cancelled_hdv_response'=>$cancelled_hdv_response];
