  ...
  class lists extends \setup { 
    public $limit,$usedstatus,$employeeno;
      ...
      function Init(){
        ...
        $result = ['request_inprogress'=>$inprogress_response, 'request_hdv_inprogress'=>$inprogress_hdv_response, 'request_new'=>$newrequests , 'request_hdv_new'=>$newhdvrequests];
...
<?php
  $action= "dashboard\\".(($class_call)? $class_call :"lists"); 
